...
%
% Arguments: univariate (xdata), univariate(ydata),
%	polynomial 'degree' of each segment,
%	'sub'intervals for breaks,
%	'noderiv' - do not ensure first derivative continuity,
%	'tol'erance for break point approximation,
%	'niter' - meximum number of iteraions,
